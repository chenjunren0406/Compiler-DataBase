...
// $ANTLR 3.2 Sep 23, 2009 12:02:23 SQL.g 2014-04-20 17:15:41
...
public class SQLParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "Identifier", "Int", "CharString", "Float", "WS", "';'", "'quit'", "'select'", "'from'", "'where'", "'group'", "'by'", "'.'", "','", "'as'", "'and'", "'('", "'or'", "')'", "'='", "'<'", "'>'", "'not'", "'sum'", "'avg'", "'count'", "'min'", "'max'", "'+'", "'-'", "'*'", "'/'"
    };
                ...
                case 1 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    match(input,17,FOLLOW_17_in_groupingClause171); 
                    	    i3=(Token)match(input,Identifier,FOLLOW_Identifier_in_groupingClause175); 
                    	    match(input,16,FOLLOW_16_in_groupingClause177); 
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    // SQL.g:78:5: ',' e2= exp
            	    {
            	    match(input,17,FOLLOW_17_in_exprList218); 
    ...
    public final void fromList() throws RecognitionException {
        ...
        try {
            ...
            match(input,18,FOLLOW_18_in_fromList245); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    match(input,17,FOLLOW_17_in_fromList263); 
            	    i3=(Token)match(input,Identifier,FOLLOW_Identifier_in_fromList267); 
            	    match(input,18,FOLLOW_18_in_fromList269); 
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    match(input,19,FOLLOW_19_in_cnfExp308); 
    ...
    public final Expression disjunction() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,20,FOLLOW_20_in_disjunction334); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    match(input,21,FOLLOW_21_in_disjunction347); 
            ...
            match(input,22,FOLLOW_22_in_disjunction360); 
    ...
    public final Expression comparison() throws RecognitionException {
        ...
        try {
            ...
            if ( ((LA10_0>=Identifier && LA10_0<=Float)||LA10_0==20||LA10_0==33) ) {
                alt10=1;
            }
            else if ( (LA10_0==26) ) {
                alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    ...
                    switch (alt9) {
                        case 1 :
                            ...
                            {
                            match(input,23,FOLLOW_23_in_comparison386); 
                        ...
                        case 2 :
                            ...
                            {
                            match(input,24,FOLLOW_24_in_comparison398); 
                        ...
                        case 3 :
                            ...
                            {
                            match(input,25,FOLLOW_25_in_comparison410); 
                ...
                case 2 :
                    ...
                    {
                    match(input,26,FOLLOW_26_in_comparison426); 
        ...
        try {
            ...
            switch (alt11) {
                case 1 :
                    ...
                    {
                    match(input,27,FOLLOW_27_in_exp447); 
                    match(input,20,FOLLOW_20_in_exp449); 
                    pushFollow(FOLLOW_addExp_in_exp453);
                    e1=addExp();

                    state._fsp--;

                    match(input,22,FOLLOW_22_in_exp455); 
                ...
                case 2 :
                    ...
                    {
                    match(input,28,FOLLOW_28_in_exp462); 
                    match(input,20,FOLLOW_20_in_exp464); 
                    pushFollow(FOLLOW_addExp_in_exp468);
                    e1=addExp();

                    state._fsp--;

                    match(input,22,FOLLOW_22_in_exp470); 
                ...
                case 3 :
                    ...
                    {
                    match(input,29,FOLLOW_29_in_exp477); 
                    match(input,20,FOLLOW_20_in_exp479); 
                    pushFollow(FOLLOW_addExp_in_exp483);
                    e1=addExp();

                    state._fsp--;

                    match(input,22,FOLLOW_22_in_exp485); 
                ...
                case 4 :
                    ...
                    {
                    match(input,30,FOLLOW_30_in_exp492); 
                    match(input,20,FOLLOW_20_in_exp494); 
                    pushFollow(FOLLOW_addExp_in_exp498);
                    e1=addExp();

                    state._fsp--;

                    match(input,22,FOLLOW_22_in_exp500); 
                ...
                case 5 :
                    ...
                    {
                    match(input,31,FOLLOW_31_in_exp507); 
                    match(input,20,FOLLOW_20_in_exp509); 
                    pushFollow(FOLLOW_addExp_in_exp513);
                    e1=addExp();

                    state._fsp--;

                    match(input,22,FOLLOW_22_in_exp515); 
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    match(input,32,FOLLOW_32_in_addExp574); 
            	...
            	case 2 :
            	    ...
            	    {
            	    match(input,33,FOLLOW_33_in_addExp589); 
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    match(input,34,FOLLOW_34_in_multExp637); 
            	...
            	case 2 :
            	    ...
            	    {
            	    match(input,35,FOLLOW_35_in_multExp652); 
        ...
        try {
            ...
            switch (alt14) {
                ...
                case 2 :
                    ...
                    match(input,16,FOLLOW_16_in_atomExp701); 
                ...
                case 5 :
                    ...
                    {
                    match(input,20,FOLLOW_20_in_atomExp744); 
                    pushFollow(FOLLOW_addExp_in_atomExp748);
                    e1=addExp();

                    state._fsp--;

                    match(input,22,FOLLOW_22_in_atomExp750); 
                    value = e1;
                ...
                case 6 :
                    ...
                    {
                    match(input,33,FOLLOW_33_in_atomExp760); 
    ...
    public static final BitSet FOLLOW_11_in_selectClause105 = new BitSet(new long[]{0x00000002F81000F0L});
    ...
    public static final BitSet FOLLOW_Identifier_in_groupingClause163 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_17_in_groupingClause171 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_Identifier_in_groupingClause175 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_16_in_groupingClause177 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_Identifier_in_groupingClause181 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_exp_in_exprList204 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_17_in_exprList218 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_exp_in_exprList222 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_Identifier_in_fromList243 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_18_in_fromList245 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_Identifier_in_fromList249 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_17_in_fromList263 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_Identifier_in_fromList267 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_18_in_fromList269 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_Identifier_in_fromList273 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_disjunction_in_cnfExp298 = new BitSet(new long[]{0x0000000000080002L});
    public static final BitSet FOLLOW_19_in_cnfExp308 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_disjunction_in_cnfExp312 = new BitSet(new long[]{0x0000000000080002L});
    public static final BitSet FOLLOW_20_in_disjunction334 = new BitSet(new long[]{0x00000002FC1000F0L});
    public static final BitSet FOLLOW_comparison_in_disjunction338 = new BitSet(new long[]{0x0000000000600000L});
    public static final BitSet FOLLOW_21_in_disjunction347 = new BitSet(new long[]{0x00000002FC1000F0L});
    public static final BitSet FOLLOW_comparison_in_disjunction351 = new BitSet(new long[]{0x0000000000600000L});
    public static final BitSet FOLLOW_22_in_disjunction360 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_addExp_in_comparison377 = new BitSet(new long[]{0x0000000003800000L});
    public static final BitSet FOLLOW_23_in_comparison386 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_addExp_in_comparison390 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_24_in_comparison398 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_addExp_in_comparison402 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_25_in_comparison410 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_addExp_in_comparison414 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_26_in_comparison426 = new BitSet(new long[]{0x00000002FC1000F0L});
    public static final BitSet FOLLOW_comparison_in_comparison430 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_27_in_exp447 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_exp449 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_addExp_in_exp453 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_22_in_exp455 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_28_in_exp462 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_exp464 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_addExp_in_exp468 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_22_in_exp470 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_29_in_exp477 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_exp479 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_addExp_in_exp483 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_22_in_exp485 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_30_in_exp492 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_exp494 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_addExp_in_exp498 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_22_in_exp500 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_31_in_exp507 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_exp509 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_addExp_in_exp513 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_22_in_exp515 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_addExp_in_exp524 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_multExp_in_addExp557 = new BitSet(new long[]{0x0000000300000002L});
    public static final BitSet FOLLOW_32_in_addExp574 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_multExp_in_addExp578 = new BitSet(new long[]{0x0000000300000002L});
    public static final BitSet FOLLOW_33_in_addExp589 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_multExp_in_addExp593 = new BitSet(new long[]{0x0000000300000002L});
    public static final BitSet FOLLOW_atomExp_in_multExp620 = new BitSet(new long[]{0x0000000C00000002L});
    public static final BitSet FOLLOW_34_in_multExp637 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_atomExp_in_multExp641 = new BitSet(new long[]{0x0000000C00000002L});
    public static final BitSet FOLLOW_35_in_multExp652 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_atomExp_in_multExp656 = new BitSet(new long[]{0x0000000C00000002L});
    public static final BitSet FOLLOW_Int_in_atomExp683 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_Identifier_in_atomExp699 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_16_in_atomExp701 = new BitSet(new long[]{0x0000000000000010L});
    ...
    public static final BitSet FOLLOW_20_in_atomExp744 = new BitSet(new long[]{0x00000002F81000F0L});
    public static final BitSet FOLLOW_addExp_in_atomExp748 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_22_in_atomExp750 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_33_in_atomExp760 = new BitSet(new long[]{0x00000002F81000F0L});
